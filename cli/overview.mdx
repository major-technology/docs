...
For local development, install Node.js 22 or later. We recommend using `nvm` (Node Version Manager) to manage multiple Node versions. You'll also need Docker and (if using AWS resources) AWS SSO configured on your machine.
