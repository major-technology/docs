...
Major automatically scans your application's TypeScript/JavaScript source code for SQL queries each time you push to the main branch. Discovered queries are cataloged and visible in the **Queries** panel inside the app editor. This requires your repository to be connected via the GitHub webhook integration.
