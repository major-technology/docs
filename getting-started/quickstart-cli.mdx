...
<Tip>
  Read [Resources](/getting-started/core-concepts#resources) to understand how resource connections work.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Resource Client" icon="database" href="/resource-client/index">
