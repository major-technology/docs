...
Go to app.major.build and sign up or sign in. You can create an app with a quick description using the new Quick-Start input, or manage resources and deploy as usual.
...
You can connect databases and APIs your app needs. Major now supports PostgreSQL (managed or your own), Snowflake, Microsoft SQL Server, and AWS resources (S3, DynamoDB) with identity-based authentication via IAM roles.
