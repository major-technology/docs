...
Apps created before your organization linked its own GitHub App continue to use Major's GitHub hosting. These apps display a **Uses Major Github** badge in the dashboard. You can create new apps that use Major's GitHub even after linking your own GitHub App — select that option during app creation.
...
### Sharing Access
You can share access to resources with specific:
- **Individuals**: Invite users by email.
- **Groups**: Grant access to entire teams at once.
