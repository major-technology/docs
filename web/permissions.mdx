...
Users manage the per-user accounts they've authorized from the [Connected Accounts](/settings/connected-accounts) settings page — viewing connected services, disconnecting them, and re-authenticating when credentials expire.
